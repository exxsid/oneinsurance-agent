...
export default function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen w-screen overflow-hidden">
      ...
      <div className="relative z-10 grid min-h-screen w-full py-4 lg:grid-cols-2">
        {/* Left column: auth card (on large screens this will be on the left) */}
        <div className="flex min-h-screen w-full items-center justify-center">
          <div className="dark:bg-card w-full max-w-md rounded-2xl bg-white p-6 sm:p-10 lg:max-w-[30rem]">
